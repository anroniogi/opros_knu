...
public:
   ...
   * 
   * If you pass GTK_ARROW_NONE for a @a direction, the menu will behave
  ...
  /** Sets the MenuModel from which the Gtk::MenuButton::property_menu() property will be
   ...
   * 
   * If you Gtk::MenuButton::property_menu() * is already set, then its content will be lost
